...
from cpsat_logutils.parsers.events import parse_event
from cpsat_logutils.parsers.parameters import parse_parameters
from cpsat_logutils.splitter import split_into_chunks, split_lines
from cpsat_logutils.text import (
    parse_duration,
    parse_int,
    parse_number,
    split_columns,
...
def test_parse_domain_shapes() -> None:
    ...
    from cpsat_logutils.parsers.domain import parse_domain
