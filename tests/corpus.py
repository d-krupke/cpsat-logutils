"""Access to the committed benchmark log corpus (``corpus/benchmark_logs.tar.xz``).
...
``corpus/README.md`` for its layout and how it was collected.
"""
...
ARCHIVE = Path(__file__).resolve().parents[1] / "corpus" / "benchmark_logs.tar.xz"
